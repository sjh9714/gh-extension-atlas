...
| Guide                                                                  | Use this when...                                                                          |
| ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| [GitHub CLI Extension Guides index][guide-index]                       | You want all workflow, install, and audit guides in one place.                            |
...
[guide-index]: https://sjh9714.github.io/gh-extension-atlas/guides/
...
| [Workflow recommendations schema][api-recommendations-schema] | You want the public data contract for recommendation workflows.    |
...
[api-recommendations-schema]: https://sjh9714.github.io/gh-extension-atlas/api/recommendations.schema.json
